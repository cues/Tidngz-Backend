...
class Articles extends Db{
 public  function get_article($user_id, $articles_id){
        ...
        foreach ($row_articles as $article){
                    ...
                    $user = New User();
                    $other_user_id = (int)$article['USER_ID'];                
                    $new_article->articles[$a]->user  = $user->get_user($user_id, $other_user_id);
                    ...
                    $new_article->articles[$a]->place = $place->get_place($user_id, (int)$place_id);
